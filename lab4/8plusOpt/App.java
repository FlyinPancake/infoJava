...
public class App {
    ...
    public static void search(String[] args) { 
        if (args.length == 2) {
            ...
            switch (args[1]) {
                ...
                case "strength":
                    for (Beer beer : beerList) {
                        if (beer.getStrength() == Double.parseDouble(args[2])) {
                            System.out.println(beer);
                        }
                    }
                    break;
                ...
                case "style":
                    for (Beer beer : beerList) {
                        if (beer.getStyle().equals(args[2])) {
                            System.out.println(beer);
                        }
                    }
                    break;
                ...
                default:
                    System.out.println("Nincs ilyen search parameter");
                    break;
            }
        } else {
    ...
    public static void find(String[] args) {
        if (args.length == 2) {
            ...
            switch (args[1]) {
                case "name":
                    for (Beer beer : beerList) {
                        if (beer.getName().contains(args[2])) {
                            System.out.println(beer);
                        }                       
                    }
                    break;
                ...
                case "style":
                    for (Beer beer : beerList) {
                        if (beer.getStyle().contains(args[2])) {
                            System.out.println(beer);
                        }
                    }
                    break;
    ...
    public static void delete(String[] args) {
        if (args.length > 1) {
            Collections.sort(beerList, new NameComparator());
            int ii = Collections.binarySearch(beerList, new Beer(args[1],null,null), new NameComparator());
            if (ii < beerList.size()&& ii > -1) {
                beerList.remove(ii);
            } else {
